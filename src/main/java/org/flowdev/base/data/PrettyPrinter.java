...
/**
 * Utility class for printing data and config objects.
 * This is useful for 'toString()' methods, debugging, ...
 */
public final class PrettyPrinter {
	...
	public static StringBuilder prettyPrintObject(String indentation, StringBuilder buf, Object obj) {
		...
		prettyPrintEntries(indentation + INDENT, buf, fieldsToEntries(obj.getClass().getFields(), obj), " = ");
	...
	public static StringBuilder prettyPrintEntries(String indentation, StringBuilder buf,
			Entry[] entries, String relation) {
	...
	public static StringBuilder prettyPrintEntry(String indentation, StringBuilder buf,
		...
		if (value == null) {
			...
			buf.append("WARNING: Arrays are not supported: ").append(value.toString());
		} else {
			switch (type) {
